...
昨今、海賊版漫画サイトに対する話題が世間を騒がせています。

「利用するのが、悪いのだ」。
無論、そうでしょう。しかし、それだけで済む問題でしょうか。 いいえ。 コンテンツ立国を目指す日本においては、横行する国外の海賊版行為だけでなく、国外の海賊版行為に対し、毅然とした態度を取る必要があるでしょう。

そのような問題に対峙するために導入された手法、「ブロッキング」。これは、DNSに対して手を加えることにより、実現しています。
さて、この手法については、その問題に対峙するのに正しい手法なのでしょうか？ 本ペーパーでは、この問題に対し、DNSの運用に携わる運用者の観点から、その問題点について掘り下げてゆきます。
